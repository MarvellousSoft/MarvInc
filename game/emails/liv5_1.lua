return {
    title = "BIG project",
    text = [[
Hey! Exciting new project coming up, and I put you on the center of it.

We up here are gonna start 'researching' brainfuck. What's gonna happen is, you're gonna write the interpreter, using L++ and the bots, we're gonna start seeing what we can do with it.
