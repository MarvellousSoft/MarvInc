...
I know I shouldn't be doing this, but you're the last person I have to turn too, and it's my own fault. If you could help me in this, I would be very grateful. Reply this email and I will send you the task. I've already done some of it, so you just need to do the end. It is about painting the floor, I've updated your manual so the 'pickup' and 'drop' commands now explain this better.
