...
The student is becoming the master, but I have one more lesson for you, {green}young grasshopper{end}. With the new {blue}Home Basic OS{end} upgrade you're getting, you can now rename {addr}registers{end}.
...
Please take note of this feature and use it to make your code clearer, as it will become more useful as your tasks get more complicated.
