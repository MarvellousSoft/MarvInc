...
But at least the record show you have completed the beta version of our latest Navigation System test room with perfection. I think you can handle the real deal now. Please let me know if you are willing to try it. Also I forgot to tell you the most important feature in the new OS you are using: you can name your registers! You can write a label for each one when your mouse is over them. You can use the name of a register as an address in our code, instead of using its number. Remember this employee.
