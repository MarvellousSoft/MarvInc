...
You can pickup and drop objects, such as giant buckets, with the commands %red% pickup %end% and %red% drop %end% . They both receive the same optional argument, a %pink% direction %end% . When provided, the %red% pickup %end% command will make the robot turn and pick any object facing that direction. If you don't provide a %pink% direction %end% , the subject will try to pick something in the direction he is facing. In both cases he puts the object in your inventory, located below your notepad in the %blue% <code> %end% tab.
