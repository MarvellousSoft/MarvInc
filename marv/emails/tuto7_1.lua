...
Example where the bot will increase the {num}value {end}of the {addr}register #1 {end}until its equal or greater than the {num}value {end}of the {addr}register #2{end}. Only then it will walk {num}7 {end}tiles.
