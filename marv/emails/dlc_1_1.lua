...
return {
    title = "EO for Continuous Collaboration",
    text = [[
...
You see, we are constantly operating with BET {gray}({red}Bleeding{gray} Edge Technologies){end}, and sometimes that edge is just a tiny bit too {red}sharp.{end}
...
I'm sure this won't take too much of your attention from your RD {gray}(Robot Department){end} duties, our previous employees who have now POtOE {gray}(Passed On to Other Endeavors){end} have left the project almost done, and our {cyan}HI automaton{end} just needs one last configuration to kickstart it's functionalities.

Whenever you can, please do this ST {gray}(Small Task){end} and I'm sure the {cyan}HI automaton{end} will lead you on with whatever else is necessary.
