...
function setup.config()
    ...
    TRAITS = {
      {"hates pizza", {}},
      {"socially awkward", {}},
      {"likes Phantom Menace", {"Jar Jar Binks is soooo underrated..."}},
      {"collects stamps", {"You know whats better than bacon? Freaking stamps man."}},
      {"color blind", {"Hey, quick question. My hair is green or red?"}},
      ...
      {"explorer at heart", {}},
      {"never pays service", {"10% it's just an absurd, don't you think?"}},
      {"jerk", {"You're ugly.", "F%$# you."}},
      {"sympathetic", {"Don't stress man, take your time. :)", "This puzzles sure are tough huh?"}},
      {"funny", {"You know the worst part of being lonely here? I can't up my frisbee game."}},
      {"cool", {}},
      {"11 toes", {}},
      {"logical", {}},
      {"irrational", {}},
      {"creepy", {"I can hear your breathing from here...:)"}},
      {"nice cook", {}},
      ...
      {"memorized moby dick", {}},
      {"lost an eye in a bear accident", {}},
      {"hates bears", {}},
      {"never finished a game without a walkthrough", {}},
      {"overachiever", {}},
      {"underacheiver", {}},
      {"always drunk", {}},
      ...
      {"accidently makes sexual innuendos", {}},
      ...
      {"constantly makes animal noises", {"Moo", "Oink Oink","Baaaaaaah", "Meeeoow ;3"}},
      {"afraid of feet", {}},
