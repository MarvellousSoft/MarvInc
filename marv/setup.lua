...
BUTS_IMG["leaderboards_blocked"] = love.graphics.newImage("assets/images/leaderboards_blocked.png")
BUTS_IMG["leaderboards_upload"] = love.graphics.newImage("assets/images/leaderboards_upload.png")
...
function setup.config()
    ...
    TRAITS = {
      ...
      {"socially awkward", {}, {}},
      {"likes Phantom Menace", {"Jar Jar Binks is soooo underrated...", "Meesa think yousa no know how to solve thisa problem.", "Let's go Podracing after this."}, {}},
      {"collects stamps", {"You know whats better than bacon? Freaking stamps man."}, {"I had almost completed my 1984 collection..."}},
      {"color blind", {"Hey, quick question. Is my hair green or red?", "Why is the floor all blue?", "Why is the floor all red?", "Why is the floor all yellow?"}, {"Hey is my blood blue?"}},
      {"puppy lover", {"Woof Woof Bark Bark :3", "Who's a good boy? :3"}, {}},
      ...
      {"listens to emo rock", {"Check out Modern Baseball", "Blink182 4 Life"}, {}},
      ...
      {"jerk", {"You're ugly.", "F%$# you.", "Screw you"}, {"F%$# you."}},
      ...
      {"good cook", {"I can cook you some Raviolli after this", "The trick to a good lasagna is to use real tomatos", "I make my own tomato sauce ;)"}, {}},
      ...
      {"obsessed with Nicolas Cage", {"Nicolas Cage is just the perfect actor.", "Have you watched Face/Off?", "Have you watched Kick-Ass? Man that Nic Cage scene.", "Have you watched Bad Lieutenant?", "Have you watched Mandy?"}, {}},
      ...
      {"thinks all his friends are john malkovich", {"Sup John, how are you?", "Good day huh John?", "Dude you were awesome on Con Air!"}, {}},
      {"memorized Moby Dick", {"I try all things, I achieve what I can."}, {}},
      {"lost an eye in a bear accident", {"An eye for an eye... That bear sure showed me.", "The world is pretty two-dimensional don't you think?", "I can't see 3D movies =("}, {}},
      {"hates bears", {"Goddamn bears stealing our honeykeeping jobs!", "Goddamn bears!!"}, {}},
      ...
      {"has to lick everything", {}, {}},
      {"has to smell everything", {}, {}},
      {"has OCD", {"Are you getting all the achievements?"}, {}},
      {"class clown", {}, {}},
      {"clown teacher", {}, {}},
      ...
      {"sucks on dirty nickels for pleasure", {}, {}},
      {"heavy sleeper", {"zzzzZZZZZzzz"}, {"zzzzZZZZZzzz"}},
      ...
      {"fan of bojack horseman", {"What is this? A crossover episode?", "Stop horsing around.", "It gets easier. But you gotta do it everyday!"}, {"That's too much man.", "Guess you'll win a free churro."}},
      {"thinks it's a pirate", {"Yaaaaaaaarrrrr"}, {"Arr, my scallywag, ya done kill me for good!"}},
      {"game of thrones fanboy", {"KHALEESI", "WHERE ARE MY DRAGONS?", "Winter is coming!!", "The red wedding was rad, right?"}, {"You know nothing.", "Valar Morghulis."}},
      ...
      {"meme guy", {"*trollface*", "Forever Alone."}, {"Forever Alone.", "le ded"}},
